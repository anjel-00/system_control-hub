      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-foreground">
            Welcome, Prof. {user?.lastName || "Faculty"}
          </h1>
          <p className="text-muted-foreground mt-1">
            Manage your facility bookings for courses and academic events
          </p>
        </div>
        <Link href="/request">
          <Button data-testid="button-new-request" className="bg-blue-600 hover:bg-blue-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <Card>
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between gap-4">
                <CardTitle className="text-lg">My Booking Requests</CardTitle>
